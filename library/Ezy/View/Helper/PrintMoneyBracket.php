 ...
 * @author kthant
 */
class Ezy_View_Helper_PrintMoneyBracket extends Zend_View_Helper_Abstract{
    //put your code here

    public function printMoneyBracket($str, $default = 'n.a.', $decimals = 2, $dec_point = '.', $thousands_sep = ','){
        if(!is_numeric($str)){
            echo $default;
        }
        else
